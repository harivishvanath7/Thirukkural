...
function App() {
  ...
  return (
                ...
                <div id="tamil">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <Typography className={classes.quoteStl} > {myKural["line2"]} </Typography> <br />
                      <Typography
                        style={{ fontWeight: "bold", fontSize: "20px" }}
                      >
                        விளக்கம்:
    ...
    <div style={{ display: 'flex', placeContent: 'center', position: 'fixed', bottom: 5, left: '0px', right: '0px' }}>
      <p> A  <span style={{ color: Helpers.textColor, fontWeight: 'bold', cursor: 'pointer' }}> SoftuxPro </span> production. </p>
    </div>
